<nav x-data="{ open: false }" class="bg-white dark:bg-amber-600 border-b border-amber-600 dark:border-amber-600">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-amber-600">
